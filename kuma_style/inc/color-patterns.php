 ...
 */
function kumastyle_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filters Kuma Style default saturation level.
	 *
	 * @since Kuma Style 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'kumastyle_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.kumastyle-front-page) .entry-title,
...
.colors-custom .kumastyle-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.kumastyle-front-page .panel-content .recent-posts article,
...
.colors-custom.kumastyle-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Kuma Style custom colors CSS.
	 *
	 * @since Kuma Style 1.0
	 *
	 ...
	 */
	return apply_filters( 'kumastyle_custom_colors_css', $css, $hue, $saturation );
}
